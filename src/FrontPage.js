    ...
    <>
      ...
      <Box
        sx={{
          ...
          position: "fixed",
          bottom: `calc(50% + min(${Math.max(0, scrollAmount - 200)}px, 50vh - 154px))`,
          zIndex: "2",
        }}
      >
      ...
      >
        ...
        >
          ...
          <Typography mt={2} mb={2} variant="h4" sx={{ fontWeight: "600", textAlign: "center" }}>
            Do education inequalities across genders contribute to gender-wealth gaps?
          </Typography>
          <Box
            sx={{
              margin: "auto",
          ...
          />
          <Typography mt={2} variant="h4" sx={{ fontWeight: "600", textAlign: "center" }}>
            How does a country’s placement on the individualism-collectivism spectrum affect its
            gender-wealth gap?
          </Typography>
          <Typography
            variant="h3"
          ...
          >
            {groupMembers.map((groupMember) => (
              <Grid
                ...
                p={1}
              >
                <ReactCardFlip isFlipped={isFlipped[groupMember.name]} loading="eager">
                  <Box
                    sx={{
          ...
          <Typography variant="body2" color="grey" mt={1} sx={{ textAlign: "center" }}>
          ...
          >
            This is a group project for UCLA's Digital Humanities 101, completed in Fall 2022 under
            the direction of Dr. Wendy Perla Kurtz. Our collective efforts involved leveraging data
            processing and visualization techniques to draw humanistic conclusions about the global
            gender-wealth gap. This final project challenged students to navigate vast datasets to
            form data-drivn narratives about humanistic topcis. Our group primarily leveraged data
            available on the{" "}
          ...
          <Typography variant="body2" color="grey" mt={1} mb={3} sx={{ textAlign: "center" }}>
...
const webNotes = [
  ...
  },
  {
    ...
    icon: <HearingDisabledIcon color="primary" sx={{ width: "80%", height: "80%" }} />,
  },
];
